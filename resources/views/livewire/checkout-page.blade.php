<div>
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:items-start">
            <div class="px-6 py-8 space-y-4 bg-white border border-primary lg:sticky lg:top-8 rounded-xl lg:order-last">
                    ...
                    <div class="-my-4 divide-y divide-gray-100">
                        ...
                        <div class="flex items-center py-4" wire:key="cart_line_{{ $line->id }}">
                            ...
                            <div class="flex-1 ml-4">
                                ...
                                <span class="block ms-auto text-right mt-1 text-xs text-gray-500">
                ...
                <div class="flow-root">
                    <dl class="-my-4 text-sm divide-y divide-gray-100">
                        <div class="flex flex-wrap py-2 text-gray-500 text-xs">
                        ...
                        <div class="flex text-gray-500 text-xs flex-wrap py-2">
                            <dt title="Value Added Tax" class="w-1/2  font-medium">
                                {{$tax->description}} {{ $tax->percentage ? ' (' . $tax->percentage . '%)' : ''}}
                            </dt>

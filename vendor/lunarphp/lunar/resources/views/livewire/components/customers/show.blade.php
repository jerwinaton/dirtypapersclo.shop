        ...
        <div class="xl:w-1/3">
            <div class="bg-white rounded shadow">
                <div class="p-4 space-y-4">
                    ...
                    <div>
                        <label class="text-xs text-gray-500" for="salutation">{{__('adminhub::inputs.salutation')}}</label>
                        <p>{{$customer->salutation}}</p>
                    </div>

                    <div>
                        <label class="text-xs text-gray-500" for="salutation">{{__('adminhub::inputs.firstname')}}</label>
                        <p>{{$customer->first_name}}</p>
                    </div>

                    <div>
                        <label class="text-xs text-gray-500" for="salutation">{{__('adminhub::inputs.lastname')}}</label>
                    ...
                    <!-- <x-hub::input.group for="account_ref" :label="__('adminhub::inputs.account_ref.label')">
                ...
                <div class="hidden p-4 text-right rounded-b bg-gray-50">
            ...
            <div>
                <div class="hidden sm:block">
                    <nav class="flex space-x-4" aria-label="Tabs">
                        ...
                        <button type="button" x-on:click.prevent="tab = 'order_history'" class="px-3 py-2 text-sm font-medium rounded-md " :class="{
                        ...
                        <button type="button" x-on:click.prevent="tab = 'purchase_history'" class="px-3 py-2 text-sm font-medium rounded-md " :class="{
                        ...
                        <!-- <button type="button" x-on:click.prevent="tab = 'users'" class="px-3 py-2 text-sm font-medium rounded-md " :class="{
                        ...
                        <a href="#" x-on:click.prevent="tab = 'addresses'" class="px-3 py-2 text-sm font-medium rounded-md " :class="{
